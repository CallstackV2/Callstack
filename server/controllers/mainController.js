...
mainController.getAllPosts = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      status: 400,
      message: {
        err: "error occurred in mainController.getAllPosts controller",
      },
    });
  }
};
...
mainController.getPostComments = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      status: 400,
      message: {
        err: "error occurred in mainController.getPostComments controller",
      },
    });
  }
};
...
mainController.searchPosts = async (req, res, next) => {
  try {
    ...
    return next({
      ...
      status: 400,
      message: {
        err: "error occurred in mainController.searchPosts controller",
      },
    });
  }
};
