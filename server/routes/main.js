...
mainRouter.post(
  "/getPostComments",
  sessionController.isLoggedIn,
  mainController.getPostComments,
  (req, res) => {
...
mainRouter.post(
  "/createPostComments",
  sessionController.isLoggedIn,
  mainController.createPostComments,
  (req, res) => {
    return res.status(200).send("NEW POST COMMENT CREATED!");
  }
);
